...
"")
        ...
        self.fecha_inicio.setGeometry(QRect(190, 220, 230, 40))
        ...
        self.lbl9_2.setGeometry(QRect(448, 10, 131, 21))
        ...
        self.line_periodoacademico.setGeometry(QRect(10, 220, 161, 40))
        ...
        self.cbo_tipo_identificacion.setGeometry(QRect(445, 36, 230, 40))
        ...
        self.label_96.setGeometry(QRect(190, 190, 161, 31))
        self.fecha_final = QDateEdit(self.frame_2)
        self.fecha_final.setObjectName(u"fecha_final")
        self.fecha_final.setGeometry(QRect(444, 220, 230, 40))
        ...
        self.label_97.setGeometry(QRect(444, 190, 161, 31))
        ...
        self.line_campoespecifico.setGeometry(QRect(240, 310, 181, 40))
        ...
        self.lbl5_2.setGeometry(QRect(444, 280, 151, 21))
        ...
        self.cbo_tutor.setGeometry(QRect(444, 310, 230, 40))
        self.lbl9_3 = QLabel(self.frame_2)
        self.lbl9_3.setObjectName(u"lbl9_3")
        self.lbl9_3.setGeometry(QRect(447, 97, 101, 21))
        ...
        self.cbo_institucion.setGeometry(QRect(444, 120, 230, 40))
