...
################################################################################
## Form generated from reading UI file 'vinculacion_nuevovLnncw.ui'
##
...
class Ui_NuevaVinculacion(object):
    def setupUi(self, NuevaVinculacion):
        ...
        NuevaVinculacion.resize(710, 650)
        NuevaVinculacion.setMinimumSize(QSize(600, 650))
        NuevaVinculacion.setMaximumSize(QSize(710, 650))
        icon = QIcon()
...
"")
        ...
        self.frame_2.setGeometry(QRect(10, 70, 691, 521))
...
"")
        ...
        self.lbl5.setGeometry(QRect(444, 270, 101, 21))
        ...
        self.line_nombreapellidos.setGeometry(QRect(10, 36, 411, 40))
        ...
        self.lbl9.setGeometry(QRect(190, 97, 81, 21))
        ...
        self.cbox_carrera.setGeometry(QRect(190, 120, 230, 40))
        ...
        self.label_95.setGeometry(QRect(444, 90, 161, 31))
        self.fecha_inicio = QDateEdit(self.frame_2)
        self.fecha_inicio.setObjectName(u"fecha_inicio")
        self.fecha_inicio.setGeometry(QRect(550, 210, 121, 40))
        ...
        self.lbl9_2.setGeometry(QRect(444, 10, 131, 21))
        ...
        self.line_identificacion.setGeometry(QRect(10, 120, 161, 40))
        ...
        self.line_periodoacademico.setGeometry(QRect(444, 120, 231, 40))
        ...
        self.cbo_tipo_identificacion.setGeometry(QRect(444, 36, 230, 40))
        ...
        self.label_96.setGeometry(QRect(550, 180, 111, 31))
        self.fecha_final = QDateEdit(self.frame_2)
        self.fecha_final.setObjectName(u"fecha_final")
        self.fecha_final.setGeometry(QRect(10, 300, 161, 40))
        ...
        self.label_97.setGeometry(QRect(10, 270, 161, 31))
        ...
        self.spb_numerohoras.setGeometry(QRect(444, 300, 230, 41))
        ...
        self.line_campoespecifico.setGeometry(QRect(190, 300, 231, 40))
        ...
        self.lbl9_5.setGeometry(QRect(190, 270, 131, 21))
        ...
        self.lbl5_2.setGeometry(QRect(10, 360, 151, 21))
        ...
        self.cbo_tutor.setGeometry(QRect(10, 390, 411, 40))
        self.lbl9_3 = QLabel(self.frame_2)
        self.lbl9_3.setObjectName(u"lbl9_3")
        self.lbl9_3.setGeometry(QRect(10, 187, 101, 21))
        ...
        self.lbl5_3.setGeometry(QRect(10, 440, 151, 21))
        ...
        self.line_codigoies.setGeometry(QRect(444, 390, 230, 40))
        ...
        self.lbl5_4.setGeometry(QRect(446, 360, 101, 21))
        self.lbl5_4.setStyleSheet(u"")
        self.lbl5_4.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        self.line_tipoinstitucion = QLineEdit(self.frame_2)
        self.line_tipoinstitucion.setObjectName(u"line_tipoinstitucion")
        self.line_tipoinstitucion.setEnabled(False)
        self.line_tipoinstitucion.setGeometry(QRect(390, 210, 131, 40))
        self.line_tipoinstitucion.setStyleSheet(u"")
        self.line_tipoinstitucion.setMaxLength(30)
        self.line_tipoinstitucion.setFrame(True)
        self.line_tipoinstitucion.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.lbl9_6 = QLabel(self.frame_2)
        self.lbl9_6.setObjectName(u"lbl9_6")
        self.lbl9_6.setGeometry(QRect(390, 180, 131, 21))
        ...
        self.btn_guardar.setGeometry(QRect(480, 600, 195, 40))
...
"")
    ...
    def retranslateUi(self, NuevaVinculacion):
        ...
        self.line_nombreapellidos.setPlaceholderText(QCoreApplication.translate("NuevaVinculacion", u"Ingrese apellidos y nombres", None))
        self.lbl11.setText(QCoreApplication.translate("NuevaVinculacion", u"Apellidos y Nombres*", None))
        ...
        self.line_identificacion.setPlaceholderText(QCoreApplication.translate("NuevaVinculacion", u"Ejm:  992928983-3", None))
        self.line_periodoacademico.setPlaceholderText(QCoreApplication.translate("NuevaVinculacion", u"Ejm:  P1-2023", None))
        ...
        self.line_campoespecifico.setPlaceholderText(QCoreApplication.translate("NuevaVinculacion", u"Ejm:  1-2A", None))
        ...
        self.line_codigoies.setPlaceholderText(QCoreApplication.translate("NuevaVinculacion", u"Ejm:  1032", None))
        self.lbl5_4.setText(QCoreApplication.translate("NuevaVinculacion", u"N\u00b0 Ies*", None))
        self.line_tipoinstitucion.setPlaceholderText("")
        self.lbl9_6.setText(QCoreApplication.translate("NuevaVinculacion", u"Tipo instituci\u00f3n*", None))
